...
const defaultOptions: RoutingOptions = {
  ...
  rules: [
    ...
    // claude-3.5/3.7-sonnet 路由到 claude-haiku-4.5（同价位更强模型）
    { sourceModel: 'claude-3.5-sonnet', targetModel: 'claude-haiku-4.5', condition: 'simple' },
    { sourceModel: 'claude-3.5-sonnet', targetModel: 'claude-haiku-4.5', condition: 'classification' },
    { sourceModel: 'claude-3.7-sonnet', targetModel: 'claude-haiku-4.5', condition: 'simple' },
    { sourceModel: 'claude-3.7-sonnet', targetModel: 'claude-haiku-4.5', condition: 'classification' },
